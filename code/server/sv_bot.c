...
==================
*/
void Q_CDECL BotImport_Print(int type, char *fmt, ...)
{
	char str[2048];
	va_list ap;
...
void SV_BotInitBotLib(void) {
	...
	// memory management
#ifdef ZONE_DEBUG
	botlib_import.Zone_AllocDebug = BotImport_ZoneAllocDebug;
#else
	botlib_import.Zone_Alloc = BotImport_ZoneAlloc;
#endif // #ifdef ZONE_DEBUG
